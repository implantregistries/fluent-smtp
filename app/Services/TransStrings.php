...
class TransStrings
{
    public static function getStrings()
    {
        return [
            ...
            'Microsoft application authorization is configured externally. Exchange Online Application RBAC is recommended to scope mailbox access; this connector does not restrict tenant permissions.' => __('Microsoft application authorization is configured externally. Exchange Online Application RBAC is recommended to scope mailbox access; this connector does not restrict tenant permissions.', 'fluent-smtp'),
