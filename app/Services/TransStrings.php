...
class TransStrings
{
    public static function getStrings()
    {
        return [
            ...
            'Application Client Secret Value (not the Secret ID)' => __('Application Client Secret Value (not the Secret ID)', 'fluent-smtp'),
            'Application Keys in Config File' => __('Application Keys in Config File', 'fluent-smtp'),
            'Application credentials (app-only)' => __('Application credentials (app-only)', 'fluent-smtp'),
            ...
            'Create and authorize the Microsoft application in Microsoft 365, then enter its credentials below. Exchange Online Application RBAC is recommended to scope mailbox access; this connector does not restrict tenant permissions.' => __('Create and authorize the Microsoft application in Microsoft 365, then enter its credentials below. Exchange Online Application RBAC is recommended to scope mailbox access; this connector does not restrict tenant permissions.', 'fluent-smtp'),
            ...
            'Delegated user authorization' => __('Delegated user authorization', 'fluent-smtp'),
            ...
            'Enter the Microsoft application credentials below. FluentSMTP stores the client-secret value using its existing encrypted settings workflow.' => __('Enter the Microsoft application credentials below. FluentSMTP stores the client-secret value using its existing encrypted settings workflow.', 'fluent-smtp'),
            ...
            'No interactive Microsoft login or callback is required. FluentSMTP will obtain and cache an application access token when the connection is saved.' => __('No interactive Microsoft login or callback is required. FluentSMTP will obtain and cache an application access token when the connection is saved.', 'fluent-smtp'),
            ...
            'Store application credentials in FluentSMTP (encrypted)' => __('Store application credentials in FluentSMTP (encrypted)', 'fluent-smtp'),
